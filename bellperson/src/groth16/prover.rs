    ...
    C: Circuit<E> + Send,
{
    ...
    let h_s = a_s
        ...
        .map(|a| {
            ...
            info!("multiexp h time: {:?}", start.elapsed());
            Ok(h)
        })
        .collect::<Result<Vec<_>, SynthesisError>>()?;
...
*/
    ...
    let l_s = aux_assignments
        ...
        .map(|aux_assignment| {
            ...
            info!("multiexp l time: {:?}", start.elapsed());
            Ok(l)
        })
        .collect::<Result<Vec<_>, SynthesisError>>()?;
  ...
  /*  let h_s_test2 = a_ts2
    ...
    let inputs = provers
        ...
        .map(|((prover, input_assignment), aux_assignment)| {
            ...
            info!("multiexp a input time: {:?}", start.elapsed());
            ...
            info!("multiexp a aux time: {:?}", start.elapsed());
            ...
            info!("multiexp b g1 input time: {:?}", start.elapsed());
            ...
            info!("multiexp b g1 aux time: {:?}", start.elapsed());
            ...
            info!("multiexp b g2 input time: {:?}", start.elapsed());
            let start = Instant::now();
            ...
            info!("multiexp b g2 aux time: {:?}", start.elapsed());
