...
where
    ...
    CS: ConstraintSystem<E>,
{
    //info!("!!!lzy!!!sha256 compression function");
    assert_eq!(input.len(), 512);
    ...
    //info!("!!!lzy!!!sha256 compression function1");
    for i in 16..64 {
        let cs = &mut cs.namespace(|| format!("w extension {}", i));
        //info!("!!!lzy!!!sha256 compression function for1");
        ...
        //info!("!!!lzy!!!sha256 compression function for2");
        ...
        //info!("!!!lzy!!!sha256 compression function for3");
        ...
        //info!("!!!lzy!!!sha256 compression function wpush");
        w.push(tmp);
    }

    //info!("!!!lzy!!!sha256 compression function1 end");
    assert_eq!(w.len(), 64);
    ...
    //info!("!!!lzy!!!sha256 compression function for4");
    for i in 0..64 {
    ...
    */
    ...
    //info!("!!!lzy!!!sha256 compression function for4 end");
    let h0 = a.compute(
    ...
    //info!("!!!lzy!!!sha256 compression function for6");
